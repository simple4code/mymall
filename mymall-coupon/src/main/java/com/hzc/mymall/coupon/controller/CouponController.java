package com.hzc.mymall.coupon.controller;
...
import com.hzc.mymall.coupon.service.CouponService;
 ...
 */
// @RefreshScope 注解，自动刷新同步Nacos配置中心中修改的配置
@RefreshScope
@RestController
...
public class CouponController {
    ...
    public R membercoupons() {
        ...
        couponEntity.setCouponName("满减卷");
